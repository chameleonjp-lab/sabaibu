...
export const STANDARD_UPGRADES: UpgradeOption[] = [
  { id: "pulse", code: "WPN-01", title: "レール増幅器", description: "最寄りの敵を狙う主砲の出力を強化する。", iconId: "pulse", category: "standard" },
  { id: "scatter", code: "WPN-24", title: "散弾アレイ", description: "移動方向へ放つ三連散弾を追加または強化する。", iconId: "scatter", category: "standard" },
...
export const MODULE_UPGRADES: UpgradeOption[] = [
  { id: "vector", code: "MOD-10", title: "ベクターランス", description: "ボス・高耐久敵を優先する高出力の槍弾を展開する。", iconId: "vector", category: "module" },
  ...
  { id: "mortar", code: "MOD-68", title: "迫撃アーク", description: "敵が最も密集する地点へ曲射弾を撃ち込み爆破する。", iconId: "mortar", category: "module" },
  ...
  { id: "laser", code: "MOD-83", title: "イオンランス", description: "ボス・高耐久敵を優先し、射線上を焼く貫通レーザー。", iconId: "laser", category: "module" },
  { id: "chain", code: "MOD-88", title: "アーク連鎖", description: "敵から敵へ伝播する高圧電撃連鎖を解き放つ。", iconId: "chain", category: "module" },
  { id: "mine", code: "MOD-94", title: "近接地雷", description: "移動した跡へ、敵が近づくと爆発する地雷を設置する。", iconId: "mine", category: "module" },
  ...
  { id: "harpoon", code: "MOD-119", title: "チェーンハープーン", description: "ボス・高耐久敵を優先し、拘束して手前へ引き寄せる。", iconId: "harpoon", category: "module" },
