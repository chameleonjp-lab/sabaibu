...
const formatCooldown = (seconds: number) => seconds >= 60 ? `${Math.floor(seconds / 60)}分${Math.ceil(seconds % 60)}秒` : `${seconds.toFixed(1)}秒`;
